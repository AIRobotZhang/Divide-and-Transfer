...
def config():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The source domain dataset name.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--mean_alpha", default=0.9, type=float, help="momentum update step"
    )
    parser.add_argument(
        "--consistency", default=100.0, type=float, help="momentum update step"
    )
    parser.add_argument(
        "--consistency_rampup", default=5, type=int, help="momentum update step"
    )
    parser.add_argument(
        "--soft_label", action="store_true", help="Start End whether to use soft labels"
    )
    parser.add_argument(
        "--loss_type", type=str, default="ce", help="Start End loss function"
    )
    parser.add_argument(
        "--eval", type=str, default="test", help="Start End loss function"
    )
