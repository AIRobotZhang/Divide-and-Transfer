...
def config():
    ...
    parser.add_argument("--per_gpu_train_batch_size_tgt", default=8, type=int, help="Batch size per GPU/CPU for training.")
    parser.add_argument(
    ...
    parser.add_argument(
        "--continu", action="store_true", help="Set this flag if continue training."
    )
    parser.add_argument("--delta", default=0.5, type=float, help="Max gradient norm.")
    parser.add_argument("--eval", default="test", type=str, help="EVAL.")
